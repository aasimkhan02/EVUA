...
class AngularProjectScaffold:
    ...
    def ensure(self):
        try:
            ...
            # src/main.ts
            self._write_if_changed(self.src_dir / "main.ts", textwrap.dedent("""\
            ...
            # src/index.html
            self._write_if_changed(self.src_dir / "index.html", textwrap.dedent("""\
                <!doctype html>
                <html lang="en">
                <head>
                    <meta charset="utf-8">
            ...
            env_dir = self.src_dir / "environments"
            self._write_if_changed(env_dir / "environment.ts", textwrap.dedent("""\
            ...
            self._write_if_changed(env_dir / "environment.prod.ts", textwrap.dedent("""\
                export const environment = {
                  production: true,
                  apiBaseUrl: '/api'
                };
            ...
            self._write_if_changed(self.app_dir / "app.component.ts", textwrap.dedent("""\
            ...
            self._write_if_changed(self.app_dir / "http.interceptor.ts", textwrap.dedent("""\
                ...
                /**
                 * Generated by EVUA.
                 * Stub interceptor for migrated AngularJS applications.
                 * Add auth headers, logging, or error handling here.
                 */
                @Injectable()
            ...
            self._write_if_changed(self.app_dir / "app.module.ts", textwrap.dedent("""\
            ...
            if not routing_path.exists():
                self._write_if_changed(routing_path, textwrap.dedent("""\
                    import { NgModule } from '@angular/core';
