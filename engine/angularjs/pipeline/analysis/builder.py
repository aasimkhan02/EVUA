...
class IRBuilder:
    ...
    def build_modules(self, raw_modules: List) -> List[Module]:
        ...
        for rm in raw_modules:
            ...
            cls.scope_methods  = getattr(rm, "scope_methods",  [])
            cls.init_calls     = getattr(rm, "init_calls",     [])
            ...
            cls.kind           = getattr(rm, "kind",           "controller")   # "controller" | "service" | "factory"
            cls.is_component   = getattr(rm, "is_component",   False)
